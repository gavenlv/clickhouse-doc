...
-- │  常用查询模式:                                              │
-- │                                                              │
-- │  1. 空间分析: system.parts → GROUP BY database, table      │
-- │  2. 性能分析: system.query_log → WHERE elapsed > 10        │
-- │  3. 健康检查: system.replicas → WHERE absolute_delay > 0   │
-- │  4. 权限审计: system.grants → GROUP BY user_name           │
-- │                                                              │
-- │  注意事项:                                                  │
-- │  - 系统表查询可能影响性能                                   │
-- │  - 定期清理日志表 (query_log)                              │
