...
-- │  User (用户):                                               │
-- │  - 登录账号                                                 │
-- │  - 认证方式: password/SSL/Kerberos/NoPassword              │
-- │  - 可分配默认角色                                           │
-- │                                                              │
-- │  Role (角色):                                               │
-- │  - 权限集合                                                 │
...
-- │                                                              │
-- │  Grant (权限):                                              │
-- │  - SELECT, INSERT, ALTER, CREATE, DROP, etc.               │
-- │  - 可指定数据库/表/列级别                                   │
-- │  - WITH GRANT OPTION 可传递权限                             │
-- │                                                              │
-- │  权限级别:                                                  │
-- │  ┌──────────────┬──────────────────────────────────────┐   │
-- │  │    级别      │              示例                     │   │
-- │  ├──────────────┼──────────────────────────────────────┤   │
-- │  │ 全局        │ GRANT ALL ON *.*                     │   │
-- │  │ 数据库      │ GRANT SELECT ON db.*                 │   │
-- │  │ 表          │ GRANT INSERT ON db.table             │   │
-- │  │ 列          │ GRANT SELECT(col1,col2) ON db.table  │   │
-- │  └──────────────┴──────────────────────────────────────┘   │
-- │                                                              │
-- │  Profile (配置文件):                                        │
-- │  - 设置参数集合                                             │
