...
-- 
-- 本文件涵盖:
--   1. 查询日志 - system.query_log
--   2. 慢查询分析 - 性能监控
--   3. Mutation 日志 - system.mutation_log
--   4. 用户活动统计 - 行为分析
--   5. 安全事件监控 - 异常检测
--   6. 性能统计 - 资源使用
--   7. 告警系统 - 物化视图告警
...
--   system.query_log
--   ┌────────────────────────────────────────────────────────────────────────┐
--   │ 记录所有查询: SQL, 用户, 时间, 资源使用                                │
--   │ 类型: QueryStart, QueryFinish, ExceptionWhileProcessing              │
--   └────────────────────────────────────────────────────────────────────────┘
--   
--   system.mutation_log
--   ┌────────────────────────────────────────────────────────────────────────┐
--   │ 记录 Mutation 操作: ALTER UPDATE/DELETE                               │
--   │ 跟踪进度: parts_to_do, is_done                                        │
--   └────────────────────────────────────────────────────────────────────────┘
--   
