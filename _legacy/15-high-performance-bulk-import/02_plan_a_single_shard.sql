...
-- 本文件涵盖:
--   1. 方案核心策略 - 多客户端并行导入策略
--   2. 优化参数配置 - 并行线程/批量大小/内存限制
--   3. 并行导入实现 - 单文件/多文件/按分区导入
--   4. 多客户端脚本 - Bash并行导入脚本示例
--   5. 性能监控查询 - 导入进度/资源使用/IO监控
--   6. 故障恢复方案 - 错误日志/数据修复
--   7. 验证与调优 - 数据完整性/参数调优建议
-- 
...
-- │  │  当前性能 (30分钟)                                                 │    │
-- │  │  ├───├───├───├───├───├───├───├───├───├───┤                       │    │
-- │  │  0   3   6   9  12  15  18  21  24  27  30 分钟                    │    │
-- │  │                                                                    │    │
-- │  │  优化后性能 (8-12分钟)                                              │    │
-- │  │  ├───┼───┼───┤                                                   │    │
-- │  │  0   2   4   6   8  10  12 分钟                                   │    │
