...
--   
--   业务特点:
--   - 订单状态频繁变化 (pending → paid → shipped → completed)
--   - 需要实时反映状态变化
--   - 历史订单状态基本不变
--   - 需要统计各状态订单数量
--   
...
--   │  表结构设计:                                                            │
--   │  - users_base: 基本信息表 (稳定)                                       │
--   │  - user_profiles: 画像表 (ReplacingMergeTree)                          │
--   │  - user_profile_changes: 变更日志表                                    │
--   │                                                                         │
--   │  更新策略:                                                              │
--   │  - 使用轻量级更新更新画像                                               │
--   │  - 同时记录变更日志                                                     │
--   │  - 定期合并画像表 (OPTIMIZE FINAL)                                      │
--   │  - 查询时使用 argMax 获取最新版本                                       │
--   └────────────────────────────────────────────────────────────────────────┘
-- 
-- ================================================================================
...
--   │  - 并行加载不同分区                                                     │
--   │  - 批量插入减少网络开销                                                 │
--   │  - 使用 DeduplicationMergeTree 自动去重                                │
--   └────────────────────────────────────────────────────────────────────────┘
-- 
-- ================================================================================
-- 案例六: 数据归档与迁移
