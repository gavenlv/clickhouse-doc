...
-- 
-- 本文件涵盖:
--   1. 当前时间获取 - now(), today(), now64()
--   2. 时间提取 - toYear(), toMonth(), toDay(), toHour()
--   3. 时间转换 - toDateTime(), toDate(), formatDateTime()
--   4. 时间对齐 - toStartOfDay(), toStartOfMonth(), toStartOfYear()
--   5. 时间差计算 - dateDiff()
--   6. 时间窗口 - 滑动窗口聚合
-- 
-- ================================================================================
...
--   │   获取函数    │         │   转换函数    │         │   计算函数    │
--   └───────────────┘         └───────────────┘         └───────────────┘
--   │ now()           │       │ toDateTime()   │       │ dateDiff()     │
--   │ today()         │       │ toDate()       │       │ addDays()      │
--   │ yesterday()     │       │ toUnixTimestamp│       │ addMonths()    │
--   │ now64()         │       │ formatDateTime │       │ subtractDays() │
--   └─────────────────┘       └────────────────┘       └────────────────┘
--           │                          │                          │
--           ▼                          ▼                          ▼
--   ┌───────────────┐         ┌───────────────┐         ┌───────────────┐
--   │   提取函数    │         │   对齐函数    │         │   解析函数    │
--   └───────────────┘         └───────────────┘         └───────────────┘
--   │ toYear()        │       │ toStartOfDay() │       │ parseDateTime  │
--   │ toMonth()       │       │ toStartOfHour()│       │ parseDateTime  │
--   │ toDayOfMonth()  │       │ toStartOfMonth│       │ BestEffort()   │
--   │ toHour()        │       │ toStartOfYear │       └────────────────┘
--   │ toMinute()      │       │ toEndOfMonth() │
--   │ toSecond()      │       └────────────────┘
--   └─────────────────┘
-- 
-- ================================================================================
...
-- ================================================================================
-- 
--   原始 DateTime: '2024-01-20 14:30:45'
--   
--   ┌────────────────────────────────────────────────────────────────────────┐
--   │                          时间线视图                                    │
--   └────────────────────────────────────────────────────────────────────────┘
...
-- ================================================================================
-- 
--   原始时间: 2024-01-20 14:30:45
--   
--   ┌─────────────────────────────────────────────────────────────────────────┐
--   │                      时间对齐到周期边界                                 │
--   └─────────────────────────────────────────────────────────────────────────┘
--   
--   toStartOfDay()    → 2024-01-20 00:00:00
--                      ┌────────────────────────────────────────┐
--                      │ 00:00 │ ... │ 14:30 │ ... │ 23:59 │
--                      │  ▲    │     │   *   │     │       │
--                      └───────┴─────┴───────┴─────┴───────┘
--   
--   toStartOfHour()   → 2024-01-20 14:00:00
--                      ┌────────────────────────────┐
--                      │ 14:00 │ 14:30 │ 14:59 │
--                      │  ▲    │   *   │       │
--                      └───────┴───────┴───────┘
--   
--   toStartOfMonth()  → 2024-01-01 00:00:00
--                      ┌──────────────────────────────────────┐
--                      │ 01 │ ... │ 20 │ ... │ 31 │
--                      │ ▲  │     │ *  │     │    │
--                      └────┴─────┴────┴─────┴────┘
