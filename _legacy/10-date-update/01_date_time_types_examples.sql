...
-- 
-- 本文件涵盖:
--   1. Date 类型 - 2 字节，存储日期（无时间）
--   2. Date32 类型 - 4 字节，扩展日期范围
--   3. DateTime 类型 - 4 字节，精确到秒
--   4. DateTime64 类型 - 8 字节，可配置精度
-- 
-- ================================================================================
-- 日期时间类型存储原理
-- ================================================================================
...
--         ▼                   ▼                   ▼                   ▼
--   ┌──────────────┐    ┌──────────────┐    ┌──────────────┐    ┌──────────────┐
--   │ 存储天数偏移 │    │ 存储天数偏移 │    │ Unix时间戳   │    │ 高精度时间戳 │
--   │ 从 1970-01-01│    │ 从 1900-01-01│    │ (秒级)       │    │ (可配置精度) │
--   └──────────────┘    └──────────────┘    └──────────────┘    └──────────────┘
--         │                   │                   │                   │
--         ▼                   ▼                   ▼                   ▼
--   ┌──────────────┐    ┌──────────────┐    ┌──────────────┐    ┌──────────────┐
--   │ 范围:        │    │ 范围:        │    │ 范围:        │    │ 范围:        │
--   │ 1970~2149年  │    │ 1900~2299年  │    │ 1970~2106年  │    │ 同 DateTime  │
--   │ (约79年)     │    │ (约400年)    │    │ (约136年)    │    │ 但精度更高   │
--   └──────────────┘    └──────────────┘    └──────────────┘    └──────────────┘
-- 
-- ================================================================================
-- 类型选择决策树
...
--                 ▼         ▼         ▼         ▼         ▼
--          ┌─────────┐ ┌────────┐ ┌────────┐ ┌────────┐ ┌────────┐
--          │  Date   │ │Date32  │ │DateTime│ │DateTime│ │DateTime│
--          │(2字节)  │ │(4字节) │ │(4字节) │ │64(3)   │ │64(6)   │
--          └─────────┘ └────────┘ └────────┘ └────────┘ └────────┘
-- 
-- ================================================================================
-- 存储效率对比
-- ================================================================================
-- 
--   类型          原始大小    压缩后(典型)    压缩比     查询性能
--   ─────────────────────────────────────────────────────────────────
--   Date          2 bytes     1-2 bytes      ~50%       ★★★★★ (最快)
--   Date32        4 bytes     2-3 bytes      ~60%       ★★★★★
--   DateTime      4 bytes     2-3 bytes      ~60%       ★★★★☆
--   DateTime64(3) 8 bytes     4-5 bytes      ~50%       ★★★☆☆
--   DateTime64(6) 8 bytes     5-6 bytes      ~60%       ★★☆☆☆ (最慢)
-- 
-- ================================================================================
