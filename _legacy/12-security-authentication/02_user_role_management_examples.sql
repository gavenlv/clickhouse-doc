...
-- 
-- 本文件涵盖:
--   1. 用户创建 - CREATE USER 语法
--   2. 用户属性 - 默认角色、主机限制、设置
--   3. 集群用户 - ON CLUSTER 创建
--   4. 用户查看 - system.users, SHOW CREATE USER
--   5. 用户修改 - ALTER USER
--   6. 用户删除 - DROP USER
--   7. 角色创建 - CREATE ROLE
--   8. 角色权限 - GRANT/REVOKE
...
--   │    ┌─────────┐         ┌─────────┐         ┌─────────────────┐         │
--   │    │  用户   │ ──────> │  角色   │ ──────> │     权限        │         │
--   │    │  User   │  GRANT  │  Role   │  GRANT  │   Permission    │         │
--   │    └─────────┘         └─────────┘         └─────────────────┘         │
--   │         │                   │                                          │
--   │         │                   │                                          │
--   │         └───── 一个用户可以有多个角色 ─────┘                            │
