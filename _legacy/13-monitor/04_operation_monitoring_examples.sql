...
-- 
-- 本文件涵盖:
--   1. DDL 操作监控 - CREATE/ALTER/DROP 统计
--   2. DML 操作监控 - INSERT/SELECT/UPDATE/DELETE 统计
--   3. Mutation 监控 - Mutation 进度和性能
--   4. Merge 监控 - Merge 操作统计
--   5. 备份恢复监控 - 备份状态和进度
--   6. 权限变更监控 - 用户权限变更追踪
--   7. 配置变更监控 - 系统配置变更
--   8. 运维自动化 - 常见运维任务
