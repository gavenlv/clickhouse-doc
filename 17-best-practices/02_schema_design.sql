...
DROP TABLE IF EXISTS tutorial.good_primary_key;
DROP TABLE IF EXISTS tutorial.over_partitioned;
DROP TABLE IF教程 tutorial.proper_partitioned;
DROP TABLE IF教程 tutorial.bad_date_type;
DROP TABLE IF教程 tutorial.good_date_type;
DROP TABLE IF教程 tutorial.normal_string;
DROP TABLE IF教程 tutorial.low_cardinality;
DROP TABLE IF教程 tutorial.events;
