...
-- │  2. 表/分区信息                                             │
-- │     - system.tables: 表元数据                              │
-- │     - system.parts: 数据 parts                            │
-- │     - system.disks: 磁盘信息                               │
-- │                                                              │
-- │  3. 复制信息                                               │
-- │     - system.replicas: 复制表状态                          │
-- │     - system.replication_queue: 复制队列                   │
-- │                                                              │
-- │  4. 查询/性能信息                                          │
-- │     - system.processes: 正在运行的查询                     │
-- │     - system.query_log: 查询日志                           │
-- │     - system.mutations: 异步 mutation                      │
-- │                                                              │
-- │  5. 指标/统计                                               │
-- │     - system.events: 事件计数器                            │
-- │     - system.metrics: 实时指标                             │
-- │     - system.metric_log: 指标日志                          │
-- │                                                              │
-- └─────────────────────────────────────────────────────────────┘
...
-- ├─────────────────────────────────────────────────────────────┤
-- │                                                              │
-- │  system.replicas 关键字段:                                    │
-- │                                                              │
-- │  - is_leader: 是否为主副本 (负责合并)                         │
-- │  - can_become_leader: 是否可以成为主副本                     │
-- │  - is_readonly: 是否只读模式                                 │
-- │  - is_session_expired: ZooKeeper 会话状态                   │
-- │  - replica_path: ZooKeeper 中的路径                         │
-- │  - queue_size: 待执行的复制队列大小                          │
...
-- │                                                              │
-- │  3. 慢查询标准:                                             │
-- │     - query_duration_ms > 1000: 1秒+                       │
-- │     - read_bytes > 1000000: 1MB+                           │
-- │                                                              │
-- │  4. 分析方法:                                               │
-- │     - 排序: ORDER BY query_duration_ms DESC                 │
-- │     - 分组: GROUP BY query_kind                            │
-- │     - 趋势: 按时间分析                                      │
-- │                                                              │
-- └─────────────────────────────────────────────────────────────┘
