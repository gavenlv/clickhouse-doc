...
-- │                                                              │
-- │  - rand(): 随机分片，数据均匀                                │
-- │  - user_id: 按用户分片，相同用户数据在一起                    │
-- │  - hash(user_id): 哈希分片                                  │
-- │  - intHash32(user_id): 32位哈希，更均匀                      │
-- │                                                              │
-- │  写入流程:                                                  │
-- │  1. 计算 sharding_key                                        │
-- │  2. 路由到对应分片                                           │
