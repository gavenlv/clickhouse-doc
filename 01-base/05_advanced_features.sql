...
-- │                                                              │
-- │  引擎选择:                                                  │
-- │  - AggregatingMergeTree: 聚合物化视图                       │
-- │  - SummingMergeTree: 求和物化视图                          │
-- │  - ReplicatedAggregatingMergeTree: 复制聚合视图             │
-- │                                                              │
-- │  工作流程:                                                  │
-- │  1. INSERT 原始表                                            │
-- │  2. 触发物化视图定义查询                                     │
...
-- │  Merge 函数:                                                 │
-- │                                                              │
-- │  - sumMerge(state): 合并多个 sum 状态                        │
-- │  - countMerge(state): 合并计数状态                          │
-- │  - avgMerge(state): 合并平均状态                            │
-- │  - uniqMerge(state): 合并去重状态                           │
-- │                                                              │
-- │  使用场景:                                                   │
-- │                                                              │
-- │  1. 分布式聚合:                                             │
...
-- │                                                              │
-- │  1. 创建投影:                                               │
-- │     ALTER TABLE t ADD PROJECTION p                          │
...
-- │  TTL 表达式:                                                │
-- │                                                              │
-- │  - 列 TTL: column_name + INTERVAL 1 DAY                    │
-- │  - 表 TTL: ALTER TABLE t TTL col + INTERVAL 1 DAY          │
-- │                                                              │
-- │  操作类型:                                                   │
-- │                                                              │
-- │  - DELETE: 删除过期数据                                      │
-- │  - TO DISK 'disk_name': 迁移到指定磁盘                       │
-- │  - TO VOLUME 'volume_name': 迁移到指定卷                    │
-- │                                                              │
-- │  执行时机:                                                  │
-- │  - 后台合并时触发                                            │
-- │  - 可以手动触发: SYSTEM RESTORE REPLICA                     │
-- │                                                              │
-- │  限制:                                                      │
-- │  - 精度为天 (Date) 或秒 (DateTime)                          │
-- │  - 异步执行 (非实时)                                        │
-- │  - 需要后台合并才能真正删除                                   │
-- │                                                              │
-- └─────────────────────────────────────────────────────────────┘
...
-- │  1. minmax: 最小最大值                                      │
│-- │     - 适合数值、日期范围                                    │
-- │     - 示例: status TYPE minmax GRANULARITY 4                │
-- │                                                              │
│-- │  2. set: 集合                                              │
│-- │     - 适合低基数 (枚举值)                                   │
-- │     - 示例: status TYPE set(1000) GRANULARITY 4            │
-- │                                                              │
│-- │  3. bloom_filter: 布隆过滤器                               │
│-- │     - 适合高基数字符串                                      │
│-- │     - 示例: url TYPE bloom_filter(0.01) GRANULARITY 4    │
-- │                                                              │
│-- │  4. ngrambf_v1: NGram 布隆过滤器                          │
-- │     - 适合模糊搜索                                          │
-- │     - 示例: text TYPE ngrambf_v1(3, 256, 2, 0)             │
-- │                                                              │
-- │  GRANULARITY:                                               │
-- │  - 索引粒度，每 N 个 mark 建立一个索引                       │
-- │  - 越小越精确，但索引越大                                     │
-- │                                                              │
-- └─────────────────────────────────────────────────────────────┘
