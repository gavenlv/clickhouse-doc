...
│-- │     - 适合：金融交易、精确库存                              │
-- │                                                              │
│-- │  4. Mutation (ALTER UPDATE/DELETE)                         │
│-- │     - 异步批量更新/删除                                    │
│-- │     - 适合：大批量修正                                      │
-- │                                                              │
│-- │  5. Lightweight DELETE                                     │
│-- │     - 快速删除标志                                         │
│-- │     - 适合：少量数据删除                                   │
-- │                                                              │
-- └─────────────────────────────────────────────────────────────┘
...
-- │                                                              │
-- │  4. 监控:                                                   │
-- │     SELECT * FROM system.mutations WHERE table = 't';       │
-- │                                                              │
-- │  限制:                                                      │
-- │  - 非事务性                                                  │
-- │  - 无法回滚                                                  │
