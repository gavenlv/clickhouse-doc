...
-- 本文件涵盖:
--   1. 全局权限 - GRANT ON *.*
--   2. 数据库权限 - GRANT ON database.*
--   3. 表权限 - GRANT ON database.table
--   4. 列权限 - GRANT SELECT(column) ON table
--   5. 字典权限 - GRANT ON DICTIONARY
--   6. 函数权限 - GRANT ON FUNCTION
--   7. 权限撤销 - REVOKE
--   8. 权限查看 - SHOW GRANTS, system.grants
-- 
-- 权限层级结构:
-- 
--   ┌─────────────────────────────────────────────────────────────────────────┐
...
--   └────────────────────────────────────────────────────────────────────────┘
--   
--   Level 2: 数据库权限 (database.*)
--   ┌────────────────────────────────────────────────────────────────────────┐
--   │ GRANT SELECT ON analytics.* TO analyst_role;                           │
--   │ → 只能访问 analytics 数据库的所有表                                     │
--   └────────────────────────────────────────────────────────────────────────┘
--   
--   Level 3: 表权限 (database.table)
--   ┌────────────────────────────────────────────────────────────────────────┐
--   │ GRANT SELECT ON analytics.users TO user_reader_role;                   │
--   │ → 只能访问 analytics.users 表                                          │
--   └────────────────────────────────────────────────────────────────────────┘
--   
--   Level 4: 列权限 (column)
--   ┌────────────────────────────────────────────────────────────────────────┐
--   │ GRANT SELECT(user_id, username) ON analytics.users TO role;            │
--   │ → 只能访问指定列                                                        │
--   └────────────────────────────────────────────────────────────────────────┘
-- 
-- ================================================================================
