...
> 本文是 04-engines 章节的"实战收尾篇"。README.md 讲透原理，本文讲透"选型决策"——为什么选 A 不选 B、错误选型会怎样、配套可运行 SQL 如何验证。
>
...
详见 [09-distributed/06_two_phase_aggregation.sql](../09-distributed/06_two_phase_aggregation.sql) 和 [05-functions/README.md](../05-functions/README.md) §3。
...
| §3 Distributed 决策 | [09-distributed/06_two_phase_aggregation.sql](../09-distributed/06_two_phase_aggregation.sql) | 两阶段聚合 + GLOBAL JOIN |
