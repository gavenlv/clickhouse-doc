...
-- 
-- 本文件涵盖:
--   1. 实时监控查询 - 当前导入任务/资源使用/磁盘IO
--   2. 历史性能分析 - 导入性能趋势/按小时统计
--   3. 表分区监控 - 数据量/压缩率/列统计
--   4. 副本状态监控 - 队列状态/延迟检测
--   5. 性能瓶颈分析 - 慢查询/内存消耗/错误分析
--   6. 集群状态监控 - 节点状态/分布式DDL队列
--   7. 实时性能指标 - 系统指标/异步指标/事件计数
--   8. 导入进度跟踪 - 进度表设计与查询
--   9. 告警查询 - 失败导入/副本延迟/磁盘空间
-- 
...
-- │  指标类别        关键指标                      健康阈值        告警阈值       │
-- │  ────────────────────────────────────────────────────────────────────────  │
-- │  导入进度        rows_per_sec                  >500K/秒       <100K/秒      │
-- │                  duration_sec                  <600秒         >1800秒       │
-- │                                                                             │
-- │  资源使用        MemoryTracking                <200GB         >240GB        │
-- │                  CPUUsage                      <80%           >95%          │
-- │                  TotalThreads                  <100           >150          │
-- │                                                                             │
-- │  副本状态        queue_size                    <100           >1000         │
-- │                  inserts_in_queue              <50            >500          │
-- │                  active_replicas               =total         <total        │
-- │                                                                             │
-- │  磁盘空间        free_space_percent            >20%           <10%          │
-- │                  queue_oldest_time             <1小时         >6小时        │
-- │                                                                             │
-- └─────────────────────────────────────────────────────────────────────────────┘
-- 
-- ================================================================================
